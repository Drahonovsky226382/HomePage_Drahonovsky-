...
function ShoppingListHeader({ recipe, currentUser, setRecipes }) {
  ...
  const handleSave = () => {
    ...
    // Aktualizace názvu v centrálním stavu recipes
    setRecipes((prev) =>
      prev.map((r) => (r.id === recipe.id ? { ...r, recipeName: newTitle } : r))
    );
    setShow(false);
  };
